...
def manage_morning_report_subscription(discord_id: int) -> str:
    """
    Adds or removes a Discord ID from morning_report_sub.json in the config/ directory.
    If the file does not exist, it is created with default metadata.
    If metadata fields (time, days) change in the script, the JSON file updates accordingly.
    ...
    :return: "added" if added, "removed" if removed
    """
    config_path = "config/morning_report_sub.json"
...
def manage_nl_east_subscription(discord_id: int) -> str:
    """
    Adds or removes a Discord ID from nleast_sub.json in the config/ directory.
    If the file does not exist, it is created with default metadata.
    If metadata fields (time, days) change in the script, the JSON file updates accordingly.
    ...
    :return: "added" if added, "removed" if removed
    """
    config_path = "config/nl_east_sub.json"
...
if __name__ == "__main__":
    ...
    action = manage_morning_report_subscription(discord_id)
