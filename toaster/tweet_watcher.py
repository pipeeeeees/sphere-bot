def _is_college_football_related(tweet_text: str, timeout: int = 15) -> bool:
    ...
    college_football_keywords = [
        ...
        "ncaa", "fbs", "fcs", "college football", "cfb", "sec", "big ten", "pac-12", "acc", "big 12",
        # Games and playoffs
        "bowl game", "bowl", "playoff", "cfp", "college football playoff",
        "signing day", "national signing day",
        # Staff
        "coach", "coaching staff", "head coach",
        # Rules and regulations
        "college football rule", "eligibility", "ncaa rule", "big ten rule",
    ]
...
- College football rules, eligibility, and NCAA regulations
- College football conferences (Big Ten, SEC, Pac-12, ACC, Big 12, etc.)
